...
export { __DO_NOT_USE__ActionTypes, applyMiddleware, bindActionCreators, combineReducers, compose, createStore, isAction, isPlainObject, legacy_createStore } from '../__federation_shared_redux-DmbPfLTD.js';
...
const {applyMiddleware,createStore,compose:compose2,combineReducers,isPlainObject:isPlainObject2} = await importShared('redux');

const {compose} = await importShared('redux');
...
const {isAction} = await importShared('redux');
...
const {isAction:isAction2,isPlainObject} = await importShared('redux');
...
const {isAction:isAction3} = await importShared('redux');
...
const {compose:compose3} = await importShared('redux');
...
const {combineReducers:combineReducers2} = await importShared('redux');
