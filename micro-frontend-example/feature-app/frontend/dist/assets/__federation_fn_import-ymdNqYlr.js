...
const moduleMap = {'react':{get:()=>()=>__federation_import(new URL('__federation_shared_react-Bfaz99l3.js', import.meta.url).href),import:true},'react-dom':{get:()=>()=>__federation_import(new URL('__federation_shared_react-dom-C8HiEUq4.js', import.meta.url).href),import:true},'react-redux':{get:()=>()=>__federation_import(new URL('__federation_shared_react-redux-CK90EKlZ.js', import.meta.url).href),import:true},'redux':{get:()=>()=>__federation_import(new URL('__federation_shared_redux-DmbPfLTD.js', import.meta.url).href),import:true},'@reduxjs/toolkit':{get:()=>()=>__federation_import(new URL('__federation_shared_@reduxjs/toolkit-C9WQr_fH.js', import.meta.url).href),import:true}};
